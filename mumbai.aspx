<%@ Page Title="" Language="C#" MasterPageFile="~/Users/User.master" AutoEventWireup="true" CodeFile="mumbai.aspx.cs" Inherits="Speakoutsign.Users_mumbai" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SpeakOutConnectionString %>" SelectCommand="SELECT * FROM [news] WHERE ([n_location] = @n_location)">
        <SelectParameters>
            <asp:Parameter DefaultValue="mumbai" Name="n_location" Type="String" />
        </SelectParameters>
