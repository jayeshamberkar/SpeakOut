<%@ Page Title="" Language="C#" MasterPageFile="~/Users/User.master" AutoEventWireup="true" CodeFile="hindi.aspx.cs" Inherits="Speakoutsign.Users_hindi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SpeakOutConnectionString %>" SelectCommand="SELECT * FROM [news] WHERE ([n_langauge] = @n_langauge)">
        <SelectParameters>
            <asp:Parameter DefaultValue="hindi" Name="n_langauge" Type="String" />
        </SelectParameters>
