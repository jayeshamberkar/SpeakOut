<%@ Page Title="" Language="C#" MasterPageFile="~/Users/User.master" AutoEventWireup="true" CodeFile="sports.aspx.cs" Inherits="Speakoutsign.Users_Categories_sports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SpeakOutConnectionString %>" SelectCommand="SELECT * FROM [news] WHERE ([n_category] = @n_category)">
        <SelectParameters>
            <asp:Parameter DefaultValue="sports" Name="n_category" Type="String" />
        </SelectParameters>
