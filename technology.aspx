<%@ Page Title="" Language="C#" MasterPageFile="~/Users/User.master" AutoEventWireup="true" CodeFile="technology.aspx.cs" Inherits="Speakoutsign.Users_Categories_technology" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SpeakOutConnectionString %>" SelectCommand="SELECT * FROM [news] WHERE ([n_category] = @n_category)">
        <SelectParameters>
            <asp:Parameter DefaultValue="technology" Name="n_category" Type="String" />
        </SelectParameters>
