<%@ Page Title="" Language="C#" MasterPageFile="~/Reporter/ReporterMaster.master" AutoEventWireup="true" CodeFile="Mynews.aspx.cs" Inherits="Speakoutsign.Reporter_Mynews" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <center>
        <div class="navbar" style="border-width: 3px; border-color: #333333; /*height: 460px*/">
            <table align="center" style="width: 1333px; height: 410px; border:1px solid blue;">
                <tr>
                    
                    <td colspan="2" align="center" class="auto-style7" >
                      
                        <h2  style="font-size: 50px;" class="auto-style6">My News</h2>
                ...
                <tr>
                    <td colspan="2" align="center" class="auto-style2">
                        ...
                        <asp:GridView ID="GridView1" runat="server" CssClass="auto-style3" AllowPaging="True" AutoGenerateColumns="False" Width="1333px" DataKeyNames="n_id" 
